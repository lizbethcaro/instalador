...
- Funciones
-
CREAR  FUNCIÓN ` fun_agregar_palabra ` ( ` p_palabra `  VARCHAR ( 255 ), ` p_id_tipo `  INT , ` p_id_idioma `  INT ) VUELVE BIT ( 1 ) COMENZAR 
	DECLARE v BIT ;
	SET v = IF (( SELECT  COUNT ( * ) FROM palabras t1 DONDE  t1 . Palabra  = p_palabra AND  t1 . Id_idioma  = p_id_idioma) =  0 , 1 , 0 );
	SI (v =  1 ) entonces
		INSERT INTO palabras (palabra, id_tipo, id_idioma)
		VALORES ( SUPERIOR (p_palabra), p_id_tipo, p_id_idioma);
		VUELTA 1 ;
	DEMÁS
		RETORNO 0 ;
	TERMINARA SI;
...
CREAR  TABLA ` idiomas` (
  ` Identificación del `  int ( 3 ) NOT NULL ,
  ` Idioma `  varchar ( 255 ) INTERCALAR colaciones utf8_spanish_ci NOT NULL ,
  ` Composicion_prosa `  varchar ( 255 ) INTERCALAR colaciones utf8_spanish_ci NO NULO
...
INSERT INTO  ` idiomas ` ( ` Identificación del ` , ` idioma ` , ` composicion_prosa ` ) VALORES
...
CREAR  TABLA ` palabras` (
  ` Identificación del `  int ( 11 ) NOT NULL ,
  ` Palabra `  varchar ( 255 ) CARÁCTER SET utf8 COLLATE utf8_bin NOT NULL ,
...
INSERT INTO  ` Palabras ` ( ` Identificación del ` , ` palabra ` , ` id_tipo ` , ` id_idioma ` ) VALORES
( 1 , ' mamá ' , 1 , 1 ),
( 2 , ' ními ' , 1 , 4 ),
( 4 , ' mi ' , 2 , 1 ),
( 6 , ' mamá ' , 1 , 1 ),
...
INSERT INTO  ` relacion_palabras ` ( ` Identificación del ` , ` id_palabra_origen ` , ` id_palabra_traduccion ` ) VALORES
( 1 , 1 , 2 ),
( 18 , 4 , 33 ),
( 28 , 10 , 49 ),
( 8 , 14 , 15 ),
...
CREAR  TABLA ` tipos` (
  ` Identificación del `  int ( 2 ) NOT NULL ,
  ` Tipo `  varchar ( 255 ) INTERCALAR colaciones utf8_spanish_ci NOT NULL ,
  ` Descripcion `  texto INTERCALAR colaciones utf8_spanish_ci NO NULO
) MOTOR = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_spanish_ci;
...
INSERT INTO  ` Tipos ` ( ` Identificación del ` , ` tipo ` , ` descripcion ` ) VALORES
...
( 3 , ' artículo ' , ' Palabra que determina un sustantivo. & Nbsp; Pueden ser determinados: el, la, los, las; o indeterminados: un, una, unos, unas. <br> <b> Los </b> quejosos trajeron <b> unas </b> pancartas. ' ),
...
CREAR  TABLA ` usuarios` (
  ` Identificación del `  int ( 3 ) NOT NULL ,
  ` Usuario `  varchar ( 255 ) INTERCALAR latin1_spanish_ci NOT NULL ,
  ` Contrasena `  varchar ( 255 ) INTERCALAR latin1_spanish_ci NO NULO
...
INSERT INTO  ` Usuarios ` ( ` Identificación del ` , ` usuario ` , ` Contraseña ` ) VALORES
...
CREATE  VIEW ` vista_idiomas `   AS  SELECT  count ( 0 ) AS  ` conteo ` , ` t1 ' . ` Idioma `  AS  ` idioma `  DE  ` idiomas `  AS  ` t1 `  DONDE  ` t1 ` . ` Identificación del `  <>  0  GROUP BY  ` t1 ' . ` Idioma ` ;
...
CREATE  VIEW ` vista_palabras `   AS  SELECT  count ( 0 ) AS  ` conteo ` , ` t1 ' . ` Palabra `  AS  ` palabra `  DE  ` Palabras `  AS  ` t1 `  DONDE  ` t1 ` . ` Identificación del `  <>  0  GROUP BY  ` t1 ' . ` Palabra ` ;
...
-
ALTER  TABLE  ` idiomas `
  ADD PRIMARY KEY ( ` Identificación del ` );

-
- Índices de la tabla `palabras`
-
...
-
- Índices de la tabla `relacion_palabras`
-
...
-
ALTER  TABLE  ` idiomas `
  MODIFY ` Identificación del `  int ( 3 ) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT = 6 ;

-
- AUTO_INCREMENT de la tabla `palabras`
-
ALTER  TABLE  ` Palabras `
  MODIFY ` Identificación del `  int ( 11 ) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT = 284 ;

-
- AUTO_INCREMENT de la tabla `relacion_palabras`
-
ALTER  TABLE  ` relacion_palabras `
  MODIFY ` Identificación del `  int ( 11 ) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT = 158 ;

-
- AUTO_INCREMENT de la tabla `tipos`
-
ALTER  TABLE  ` Tipos `
  MODIFY ` Identificación del `  int ( 2 ) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT = 11 ;

-
- AUTO_INCREMENT de la tabla `usuarios`
-
ALTER  TABLE  ' usuarios '
  MODIFY ` Identificación del `  int ( 3 ) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT = 2 ;
...
-
ALTER  TABLE  ` Palabras `
  ADD CONSTRAINT  ` palabras_ibfk_1 `  FOREIGN KEY ( ` id_tipo ` ) Referencias  ` Tipos ` ( ` Identificación del ` ) ON DELETE CASCADE  EN  ACTUALIZACIÓN CASCADE,
  ADD CONSTRAINT  ` palabras_ibfk_2 `  FOREIGN KEY ( ` id_idioma ` ) Referencias  ` idiomas ` ( ` Identificación del ` ) ON DELETE CASCADE  EN  ACTUALIZACIÓN CASCADE;

-
- Filtros para la tabla `relacion_palabras`
-
ALTER  TABLE  ` relacion_palabras `
  ADD CONSTRAINT  ` relacion_palabras_ibfk_1 `  FOREIGN KEY ( ` id_palabra_origen ` ) Referencias  ` Palabras ` ( ` Identificación del ` ) ON DELETE CASCADE  EN  ACTUALIZACIÓN CASCADE,
  ADD CONSTRAINT  ` relacion_palabras_ibfk_2 `  FOREIGN KEY ( ` id_palabra_traduccion ` ) Referencias  ` Palabras ` ( ` Identificación del ` ) ON DELETE CASCADE  EN  ACTUALIZACIÓN CASCADE;
COMPROMISO ;
